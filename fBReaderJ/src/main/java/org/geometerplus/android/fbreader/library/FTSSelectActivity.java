...
public class FTSSelectActivity extends TreeActivity<LibraryTree> implements MenuItem.OnMenuItemClickListener, View.OnCreateContextMenuListener, IBookCollection.Listener {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        myCollection.bindToService(this, new Runnable() {
            public void run() {
                ...
                myCollection.addListener(FTSSelectActivity.this);
                Log.v("FTS", "before init");
                init(getIntent());
                Log.v("FTS", "after init");
    ...
    private void showBookInfo(Book book) {
        ...
        Log.v("Book id", String.valueOf(book.getId()));
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                if (found) {
                    ...
                    UIUtil.showErrorMessage(FTSSelectActivity.this, "bookNotFound");
                }
            }
        });
    }
